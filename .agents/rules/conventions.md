...
- Keep anti-slop vendored as JavaScript so Node 20 can load it without a TypeScript loader. Pin `oxlint` and `@oxlint/plugins` to the same exact version in the repo and generated projects.
