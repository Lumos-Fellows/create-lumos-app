...
- Typecheck anti-slop’s retained TypeScript source, and ship its compiled JavaScript so Node 20 can load it without a TypeScript loader. Pin `oxlint` and `@oxlint/plugins` to the same exact version in the repo and generated projects.
